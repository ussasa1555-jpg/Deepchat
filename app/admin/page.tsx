        ...
        <div className="terminal space-y-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-3">
            <Link href="/admin/chat" className="block">
              <div className="retro-button text-center p-4 hover:bg-accent/10 transition-colors h-full border-2 border-accent/50">
                ...
                <span className="text-sm text-accent font-bold">Admin Chat</span>
              </div>
            </Link>

            <Link href="/admin/users" className="block">
              <div className="retro-button text-center p-4 hover:bg-accent/10 transition-colors h-full">
                <svg className="w-8 h-8 text-accent mx-auto mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" />
                </svg>
                <span className="text-sm text-accent">Users</span>
              </div>
            </Link>
            ...
            <Link href="/admin/rooms" className="block">
              <div className="retro-button text-center p-4 hover:bg-accent/10 transition-colors h-full">
                ...
                <span className="text-sm text-accent">Rooms</span>
              </div>
            </Link>

            <Link href="/admin/threats" className="block">
              <div className="retro-button text-center p-4 hover:bg-accent/10 transition-colors h-full">
                <svg className="w-8 h-8 text-retro-amber mx-auto mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" />
                </svg>
                <span className="text-sm text-retro-amber">Threats</span>
              </div>
            </Link>
            ...
            <Link href="/admin/audit-logs" className="block">
              <div className="retro-button text-center p-4 hover:bg-accent/10 transition-colors h-full">
                ...
                <span className="text-sm text-accent">Audit Logs</span>
              </div>
            </Link>
          </div>
